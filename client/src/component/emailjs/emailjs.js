  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        ...
        "template_cvrnvzh",
        e.target,
        "user_Rx3I0704PL1aG8AASNv5Y"
      )
      .then(
        (result) => {
          console.log(result.text);
          toast.success(
            "your email sent Successfully,thank you for your feedback",
            {
    ...
    <div className="container-emailjs">
      <form onSubmit={sendEmail}>
        <div className="form-input-emailjs">
          <span className="create">Contact Us</span>
          ...
          <div className="form-name-emailjs">
            ...
            <input
              ...
              name="name"
              className="form-inp-but-emailjs"
              required
            />
            <br />
          </div>
          ...
          <div className="form-textarea2-emailjs">
            ...
            <textarea
              ...
              className="form-textarea-emailjs"
              name="message"
              required
            />
            <br />
